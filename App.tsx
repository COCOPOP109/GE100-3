      ...
      <div className="h-full w-full overflow-y-auto snap-y snap-mandatory scroll-smooth snap-container">
        ...
        <Section id="home" className="bg-black" backgroundImage="https://images.unsplash.com/photo-1466611653911-95081537e5b7?q=80&w=2070&auto=format&fit=crop">
           ...
           <div className="relative z-10 max-w-6xl mx-auto text-center space-y-8 text-white px-4">
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold tracking-tight leading-none text-white drop-shadow-xl">
              绿电百分百<br />
             ...
             <div className="relative h-full flex flex-col justify-center">
                <div className="relative rounded-[2.5rem] overflow-hidden shadow-2xl aspect-[4/3] group">
                   ...
                   <div className="absolute bottom-8 left-8 text-white">
                      <div className="text-4xl font-bold">2050</div>
                      <div className="text-sm opacity-80">实现100%绿电转型目标</div>
                   </div>
                </div>
             </div>
                ...
                <div className="space-y-4">
                   ...
                   <div className="space-y-4">
                     {[
                       ...
                       <div key={i} className="flex items-center gap-4 p-5 rounded-2xl bg-slate-50 border border-slate-100 hover:border-emerald-200 transition-all">
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[
                  ...
                  { 
                   ...
                   <div key={i} className="bg-white p-10 rounded-[2.5rem] border border-slate-100 shadow-sm hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 flex flex-col items-center text-center group">
                      <div className={`w-24 h-24 rounded-full bg-${card.color}-50 text-${card.color}-600 flex items-center justify-center mb-8 group-hover:scale-110 transition-transform duration-300`}>
                        {card.icon}
                      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-7xl mx-auto w-full">
            ...
            <div className="grid grid-cols-2 gap-4 relative">
               <img 
                ...
                alt="Conference" 
                className="rounded-3xl shadow-lg w-full h-64 object-cover translate-y-8"
               />
               <img 
                ...
                className="rounded-3xl shadow-lg w-full h-64 object-cover -translate-y-8"
               />
               <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white/90 backdrop-blur-xl p-6 rounded-2xl shadow-xl border border-white/50 text-center w-48">
                  <div className="text-3xl font-bold text-emerald-600">20+</div>
                  <div className="text-xs text-slate-500 uppercase font-bold mt-1">联合响应机构</div>
               </div>
            </div>
          </div>
        </Section>
        ...
        <Section id="join" className="bg-white bg-pattern-waves">
           <div className="max-w-7xl mx-auto w-full flex flex-col justify-center h-full items-center">
              ...
              {/* Steps Visualization */}
              <div className="w-full relative mb-20 px-4 md:px-0">
                    ...
                    {[
                      ...
                      { 
                       ...
                       <div key={i} className="flex flex-col items-center text-center group">
                          <div className="w-20 h-20 rounded-full bg-emerald-50/50 border border-emerald-100 shadow-sm flex items-center justify-center mb-8 group-hover:border-emerald-400 group-hover:shadow-md transition-all duration-300 relative z-10">
                             {step.icon}
                          </div>
              ...
              {/* Downloads Area */}
              <div className="w-full max-w-5xl bg-slate-50 rounded-2xl border border-slate-100 p-8 flex flex-col md:flex-row items-center justify-between gap-6">
                  ...
                  <div className="flex gap-4">
                     <Button variant="outline" className="bg-white hover:bg-emerald-50 border-slate-200 hover:border-emerald-200 text-slate-600 hover:text-emerald-700">
                        目标框架文档 ↳
                     </Button>
                     <Button variant="outline" className="bg-white hover:bg-emerald-50 border-slate-200 hover:border-emerald-200 text-slate-600 hover:text-emerald-700">
                        技术指南 PDF ↳
        ...
        <Section id="join-form" className="bg-slate-50 bg-pattern-grid">
           <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 max-w-7xl mx-auto w-full items-center">
              ...
              <div className="lg:col-span-7 bg-white p-8 md:p-12 rounded-[2.5rem] shadow-xl border border-slate-100 relative overflow-hidden">
           ...
           <div className="max-w-7xl mx-auto w-full h-full flex flex-col justify-center gap-10">
              <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
                 <div>
                    ...
                    <p className="text-slate-500 mt-2 text-lg">引领行业规范，定义绿色未来</p>
                 </div>
                 <Button variant="outline" size="sm">查看更多案例</Button>
              </div>
        ...
        <Section id="resources-events" className="bg-slate-50 bg-pattern-grid">
           <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="bg-white p-8 md:p-10 rounded-xl shadow-xl border border-slate-100">
        ...
        <Section id="members" className="bg-slate-50 bg-pattern-grid">
          <div className="max-w-7xl mx-auto w-full h-full flex flex-col pt-36 pb-10">
            ...
            <div className="flex-1 overflow-auto bg-white rounded-[2rem] border border-slate-200 shadow-2xl custom-scrollbar relative">
              <table className="w-full text-left border-collapse">
                <thead className="bg-slate-50/80 backdrop-blur-md sticky top-0 z-10 border-b border-slate-200">
                  <tr>
                    <th className="p-6 text-xs font-bold text-slate-500 uppercase tracking-wider pl-8">公司名称</th>
                    <th className="p-6 text-xs font-bold text-slate-500 uppercase tracking-wider">成员级别</th>
                    <th className="p-6 text-xs font-bold text-slate-500 uppercase tracking-wider hidden md:table-cell">行业</th>
                    <th className="p-6 text-xs font-bold text-slate-500 uppercase tracking-wider hidden md:table-cell">总部</th>
                    <th className="p-6 text-xs font-bold text-slate-500 uppercase tracking-wider text-right pr-8">目标年份</th>
                  </tr>
                </thead>
            ...
            <div className="mt-8 flex justify-center text-sm text-slate-400">
